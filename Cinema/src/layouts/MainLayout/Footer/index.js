        ...
        <div className="col-6 col-md-4 footer__company d-none d-lg-block d-xl-block">
          ...
          <div>
            <div className={classes.company__logo}>
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://www.bhdstar.vn/"><img src="/img/logo-connect/bhd.png" alt="" className={classes.logo} /></a>
              <a target="_blank" rel="noopener noreferrer" href="https://www.galaxycine.vn/"><img src="/img/logo-connect/galaxycine.png" alt="" className={classes.logo} /></a>
              <a target="_blank" rel="noopener noreferrer" href="https://cinestar.com.vn/"><img src="/img/logo-connect/cinestar.png" alt="" className={classes.logo} /></a>
              <a target="_blank" rel="noopener noreferrer" href="https://www.lottecinemavn.com/"><img src="/img/logo-connect/lotte.png" alt="" className={classes.logo} /></a>
            </div>
            <div className={classes.company__logo}>
              <a target="_blank" rel="noopener noreferrer" href="https://www.megagscinemas.vn/"><img src="/img/logo-connect/megags.png" alt="" className={classes.logo} /></a>
              <a target="_blank" rel="noopener noreferrer" href="https://www.betacinemas.vn/"><img src="/img/logo-connect/bt.jpg" alt="" className={classes.logo} /></a>
              <a target="_blank" rel="noopener noreferrer" href="http://ddcinema.vn/"><img src="/img/logo-connect/dongdacinema.png" alt="" className={classes.logo} /></a>
            ...
            <div className={classes.company__logo}>
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://zalopay.vn/"><img src="/img/logo-connect/zalopay_icon.png" alt="" className={classes.logo} /></a>
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://portal.vietcombank.com.vn/"><img src="/img/logo-connect/vcb.png" alt="" className={classes.logo} /></a>
            </div>
            <div className={classes.company__logo}>
              <a target="_blank" rel="noopener noreferrer" href="https://momo.com/"><img src="/img/logo-connect/momo.png" alt="" className={classes.logo} /></a>
              <a target="_blank" rel="noopener noreferrer" href="https://www.viettinbank.vn/"><img src="/img/logo-connect/VIETTINBANK.png" alt="" className={classes.logo} /></a>
